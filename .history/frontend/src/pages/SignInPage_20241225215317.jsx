    ...
    >
      ...
      >
        ...
        <Text mb="4" color="white">
          ...
          <Link as={RouterLink} to="/register" color="purple.700" fontWeight="bold">
            Register
          </Link>
        </Text>
        ...
        <FormControl mb="4" isRequired>
          ...
          <InputGroup>
            <InputLeftElement pointerEvents="none">
              <FaUser color="gray" aria-label="user-icon" />
            </InputLeftElement>
            <Input
              type="email"
        ...
        <Button
          ...
          disabled={isLoading}
        >
          {isLoading ? <Spinner size="sm" color="white" /> : 'ACCESS MY ACCOUNT'}
        </Button>
